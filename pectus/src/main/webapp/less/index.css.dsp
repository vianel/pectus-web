...
.nav-user > div .user-menu.green {
  background-color: #85BFE6 ! important;
}
...
.nav-user > div .user-menu.light-blue .z-menu-selected {
  background-color: #58948A ! important;
}
...
.btn-info:hover,
.btn-info.open {
  background-color: #49D2CE !important;
  border-color: #6fb3e0;
}
...
.z-window {
	background: #FCE7F7;
	border: 7px solid #ffcccc !important;
}
.z-label {
	color: #808184;
}
